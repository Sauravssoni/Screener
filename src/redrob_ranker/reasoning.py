def generate_reasoning(candidate, features, traps, evidence=None):
    ...
    title = prof.get("current_title", "Unknown Role").strip()
    if not title:
        title = "Candidate"
    ...
    # Ensure it reflects why they might be excluded or included.
